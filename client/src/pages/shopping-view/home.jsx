...
import bannerOne from "@/assets/one.webp";
import bannerTwo from "@/assets/two.webp";
import bannerThree from "../../assets/three.webp";
import { 
  Airplay,
  BabyIcon,
  ChevronLeftIcon,
...
function ShoppingHome() {
  ...
  console.log(categoriesWithIcon, "categewefwef")
    ...
    return (
      ...
      <div className="relative w-full h-[600px] overflow-hidden border border-red-600">
